...
# 初始化模型并加载参数
model = RMT_T3(None)
checkpoint = torch.load("/home/zengshimao/code/RMT/rankControl/all_rank/best.pth", map_location='cpu',weights_only=False)
...
output_file = "effective_ranks_svdControl.json"
