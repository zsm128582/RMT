...
from tokenGalerkin_v2_fixResidual.segmentBackbone import tokengalerkin_v2_fixResidual
archs = {
            'RMT_T': RMT_T3,
            # 'RMT_S': RMT_S,
            # 'RMT_B': RMT_M2,
            ...
            'tokengalerkin_v2_fixResidual':tokengalerkin_v2_fixResidual
...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19','IMNET_SUBSET'],
    ...
    parser.add_argument('--sub-classes', type=int, default=1000, metavar='N',
