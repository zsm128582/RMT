...
class TokenAttentionLayer(nn.Module):
    ...
    #     print("call layer weight decay check")
    #     return {'q_pos'}
...
class VisSegNet(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
        ...
        # 删除了 0.02 ，期望不坍缩
        self.agents = nn.Parameter(torch.randn(1, self.num_q, self.embed_dim))
    ...
    def forward_features(self, x , epoch):
        ...
        queries = self.agents.expand(b , -1, -1)
...
@register_model
def tokengalerkin_v2_t_fixWeightDecay(args):
    model = VisSegNet(
