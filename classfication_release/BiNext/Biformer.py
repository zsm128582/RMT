...
@register_model
def binext_tiny(args ,pretrained=False, pretrained_cfg=None,
...
@register_model
def binext_small(pretrained=False, pretrained_cfg=None,
                   pretrained_cfg_overlay=None, **kwargs):
    model = BiFormer(
        depth=[4, 4, 18, 4],
        embed_dim=[64, 128, 256, 512], mlp_ratios=[3, 3, 3, 3],
...
@register_model
def biformer_base(args,pretrained=False, pretrained_cfg=None,
                  pretrained_cfg_overlay=None, **kwargs):
    model = BiFormer(
        num_classes=args.nb_classes,
        depth=[4, 4, 18, 4],
