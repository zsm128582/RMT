...
if __name__ == '__main__':
    ...
    resume = "/root/code/RMT/classfication_release/work_dirs/Unet/unet_t/checkpoint.pth"
    ...
    img = Image.open("/root/datasets/Imagenet1k/val/n01440764/n01440764_10306.JPEG").convert("RGB")
    ...
    for h in hooks:
        h.remove()
        # --- 运行可视化 ---
    visualize_attention(input_tensor.squeeze(0).detach().cpu().numpy(), mask.squeeze(0).detach().cpu().numpy(), top_k=5)
