...
)       
{
    ...
    AT_DISPATCH_FLOATING_TYPES(d_atten.scalar_type(), "sparse_attention_backward_query_kernel", ([&] {
    ...
    AT_DISPATCH_FLOATING_TYPES(d_atten.scalar_type(), "sparse_attention_backward_key_kernel", ([&] {
